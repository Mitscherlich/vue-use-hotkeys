...
const PropTypes = {
  func: { type: Function },
  looseBool: { type: Boolean, default: undefined },
};
...
HotKeysWithRef.props = { onPress: PropTypes.func };
...
HotkeysOnKeyup.props = {
  ...
  keydown: PropTypes.looseBool,
  keyup: PropTypes.looseBool,
};
